...
namespace GUI_V_2.ViewAdm
{
    public partial class CrearCapacitaciones : Form
    {
        ...
        private void BtnCrear_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                commands.executeCommand("INSERT INTO Capacitacion ( Candidato_ID, Descripcion, Nivel_Academico, Fecha_Desde, Fecha_Hasta, Institucion) VALUES ('" + Descricion.Text.ToString() + "', '" +
