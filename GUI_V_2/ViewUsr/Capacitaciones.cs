...
namespace GUI_V_2
{
    ...
    public partial class Capacitaciones : Form
    {
        ...
        public void LoadData()
        {
           ...
           dataGridView1.DataSource = CapacitacionesConexion.getData("SELECT Capacitacion.Capacitacion_ID, Descripcion, Nivel_Academico, Fecha_Desde, Fecha_Hasta, Institucion FROM Capacitacion inner join Candidato ON Capacitacion.Candidato_ID = Candidato.Candidato_ID;");
        }
        ...
        {
            CapacitacionesConexion.executeCommand("Delete from Capacitacion where Candidato_ID = '" + dataGridView1.CurrentRow.Cells[0].Value.ToString() + "'");
            LoadData();
        }
